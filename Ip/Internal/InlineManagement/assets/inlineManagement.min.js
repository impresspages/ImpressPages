(function($){"use strict";$(document).ready(function(){$('.ipsModuleInlineManagementLogo').ipModuleInlineManagementLogo();$('.ipModuleInlineManagement.ipmText').ipModuleInlineManagementText();$('.ipModuleInlineManagement.ipmImage').ipModuleInlineManagementImage();});})(ip.jQuery);(function($){"use strict";var hideTimer=0,controlsClass='ipsModuleInlineManagementControls',hiliteClass='_hilite',methods={init:function(options){return this.each(function(){var $this=$(this);if(!$('.'+controlsClass).length){$('body').append(ipModuleInlineManagementControls);}
