(function($){"use strict";$(document).ready(function(){$('.ipsModuleInlineManagementLogo').ipModuleInlineManagementLogo();$('.ipsModuleInlineManagementText').ipModuleInlineManagementText();$('.ipsModuleInlineManagementImage').ipModuleInlineManagementImage();});})(ip.jQuery);(function($){"use strict";var hideTimer=0,controlsClass='ipsModuleInlineManagementControls',hiliteClass='_hilite',methods={init:function(options){return this.each(function(){var $this=$(this);if(!$('.'+controlsClass).length){$('body').append(ipModuleInlineManagementControls);}
...
console.log($this.data('options'));$.each($this.data('options'),function(name,value){options[name]=value;});console.log('6');var $imageUploader=$popup.find('.ipsImage');$imageUploader.ipUploadImage(options);$imageUploader.bind('change.ipUploadImage',$.proxy(methods._preview,$this));$this.bind('error.ipUploadImage',{widgetController:this},methods._addError);}
