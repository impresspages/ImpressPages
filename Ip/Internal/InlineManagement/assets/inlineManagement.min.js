...
return;ul.slideUp('fast',function(){visible=false;});root.find('.ipsFontName').html($(this).text());root.css('font-family',$(this).css('font-family'));if($(this).hasClass('ipsDefaultFont')){settings['selected']('');}else{settings['selected']($(this).css('font-family'));}});$(this).click(function(event){if(visible)
