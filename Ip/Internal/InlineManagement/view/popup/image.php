...
<div class="ipmControls ipsControls">
    ...
    <?php if (isset($showRemoveLink) && $showRemoveLink) { ?>
        ...
        <div class="ipgHide ipsRemoveConfirm"><?php _e('There is no option to undo this action. Parent page image or the default one will be applied to this page. Do you want to proceed?', 'ipAdmin'); ?></div>
    <?php } ?>
    <br/>
