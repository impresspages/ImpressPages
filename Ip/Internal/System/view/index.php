<div class="ipModuleSystem">
    ...
    <div>
        <h2><?php _e('Release History', 'Ip-admin'); ?></h2>
        <?php _e('See more at:', 'Ip-admin'); ?> <a href="http://www.impresspages.org/releases" target="_blank">www.impresspages.org/releases</a>
    </div>
