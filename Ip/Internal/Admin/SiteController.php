...
class SiteController extends \Ip\Controller
{
    ...
    public function removeAdminIsAutogeneratedAjax() //TODOX move to AdminController
    {
        ipRequest()->mustBePost();

        // If user is not logged in, we cannot perform this task
        if (!\Ip\Internal\Admin\Backend::userId()) { //TODOX remove when moved to AdminController
            return \Ip\Response\JsonRpc::error(__('You must be logged in to perform this task.', 'Ip-admin', false));
        }
    ...
    public function loginAjax()
    {
        ...
        \Ip\Internal\System\Model::sendUsageStatistics($usageStatistics); //TODOX increases login time twice. Use AJAX after login.
