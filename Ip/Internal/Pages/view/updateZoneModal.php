<div class="ipsUpdateZoneModal modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title"><?php _e('Update menu zone', 'ipAdmin') ?></h4>
            </div>
            <div class="modal-body">
                ...
                <div class="ipsDeleteConfirmation ipgHide">
                    <div class="alert alert-danger"><?php _e('All pages inside this zone will be deleted. This will affect all languages. Are you sure you want to proceed?', 'ipAdmin'); ?></div>
