...
var $columnsWidget=$block.closest('.ipWidget-Columns');if($columnsWidget.length){deleteEmptyColumns($columnsWidget.data('widgetinstanceid'),function(){if(callback){callback($newWidget.data('widgetinstanceid'));}});}},dataType:'json'});}
...
if(block!=curBlock||curPosition!=position){if(side){ipContent.moveWidgetToSide(sourceWidgetInstanceId,targetWidgetInstanceId,leftOrRight);}else{ipContent.moveWidget(instanceId,position,block,ip.revisionId);}}}
