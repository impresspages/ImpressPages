...
this.createWidgetInsideWidget=function(widgetName,targetWidgetInstanceId,position,callback){var revisionId=ip.revisionId;this.splitWidget(targetWidgetInstanceId,position,function(firstWidgetInstanceId,secondWidgetInstanceId){var $firstWidget=$('#ipWidget-'+firstWidgetInstanceId);var blockName=$firstWidget.closest('.ipBlock').data('ipBlock').name;var firstWidgetPosition=$firstWidget.index();ipContent.createWidget(revisionId,blockName,widgetName,firstWidgetPosition+1,function(instanceId){if(callback){callback(instanceId);}});});}
this.moveWidgetInsideWidget=function(sourceWidgetInstanceId,targetWidgetInstanceId,position,callback){var revisionId=ip.revisionId;this.splitWidget(targetWidgetInstanceId,position,function(firstWidgetInstanceId,secondWidgetInstanceId){var $firstWidget=$('#ipWidget-'+firstWidgetInstanceId);var blockName=$firstWidget.closest('.ipBlock').data('ipBlock').name;var firstWidgetPosition=$firstWidget.index();ipContent.moveWidget(sourceWidgetInstanceId,firstWidgetPosition+1,blockName,ip.revisionId,function(instanceId){if(callback){callback(instanceId);}});});}
...
return;}
var splitData=widgetController.splitData($widget.data('widgetdata'),position);this.deleteWidget(widgetInstanceId,function(){context.createWidget(ip.revisionId,blockName,widgetName,widgetPosition,function(firstWidgetInstanceId){var $firstWidget=$('#ipWidget-'+firstWidgetInstanceId);$firstWidget.ipWidget('save',splitData[0],true);context.createWidget(ip.revisionId,blockName,widgetName,widgetPosition+1,function(secondWidgetInstanceId){var $secondWidget=$('#ipWidget-'+secondWidgetInstanceId);$secondWidget.ipWidget('save',splitData[1],true);if(callback){callback(firstWidgetInstanceId,secondWidgetInstanceId);}});});});}
...
if(block!=curBlock||curPosition!=position){if(side){ipContent.moveWidgetToSide(sourceWidgetInstanceId,targetWidgetInstanceId,leftOrRight);}else if(newCol){ipContent.moveWidgetToColumn(sourceWidgetInstanceId,targetWidgetInstanceId,position);}else if(paragraph){ipContent.moveWidgetInsideWidget(sourceWidgetInstanceId,targetWidgetInstanceId,position);}else{ipContent.moveWidget(instanceId,position,block,ip.revisionId);}}}
