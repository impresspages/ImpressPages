...
$context.find(".ipsFieldOptionsContainer").sortable();$context.find(".ipsFieldOptionsContainer").sortable('option','handle','.ipsOptionMove');};ipWidgetForm_SaveListOptions=function($context){var $options=$context.find('.ipsFieldOptionsContainer .ipsOptionLabel');var answer=new Array();answer=new Array();$options.each(function(i){var $this=$(this);answer.push($this.val());});return{list:answer};};ipWidgetForm_InitWysiwygOptions=function($context,currentOptions){if(currentOptions&&currentOptions.text){$context.find(".ipsFieldOptionsRichText").html(currentOptions.text);}
$context.find(".ipsFieldOptionsRichText").tinymce(ipTinyMceConfig());};ipWidgetForm_SaveWysiwygOptions=function($context){return{text:$context.find('.ipsFieldOptionsRichText').html()};};})(ip.jQuery);var IpWidget_Gallery;(function($){"use strict";IpWidget_Gallery=function(){this.$widgetObject=null;this.data=null;this.$controls=null;this.$widgetControls=null;this.init=function($widgetObject,data){var currentScope=this;this.$widgetObject=$widgetObject;this.data=data;this.$widgetControls=$('#ipWidgetGalleryControls');this.$widgetObject.on('click',$.proxy(this.focus,this));$('body').on('click',$.proxy(function(e){var $target=$(e.target);if(!$target.hasClass('ipWidget-Gallery')){$target=$target.closest('.ipWidget-Gallery');}
