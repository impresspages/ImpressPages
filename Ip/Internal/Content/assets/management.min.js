...
return;}
var splitData=widgetController.splitData($widget.data('widgetdata'),position);this.deleteWidget(widgetInstanceId,function(){context.createWidget(blockName,widgetName,widgetPosition,function(firstWidgetInstanceId){var $firstWidget=$('#ipWidget-'+firstWidgetInstanceId);$firstWidget.ipWidget('save',splitData[0],true);context.createWidget(blockName,widgetName,widgetPosition+1,function(secondWidgetInstanceId){var $secondWidget=$('#ipWidget-'+secondWidgetInstanceId);$secondWidget.ipWidget('save',splitData[1],true);if(callback){callback(firstWidgetInstanceId,secondWidgetInstanceId);}});});});}
