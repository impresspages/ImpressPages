...
this.blur=function(e){if($.contains(this.$widgetObject[0],e.target)||this.$widgetObject[0]==e.target){console.log('inside');return;}else{if($.contains(this.$controls[0],e.target)||$.contains($('#ipWidgetTitleOptions')[0],e.target)){}else{this.removeControls()}}};this.removeControls=function(){this.$controls.addClass('hide');this.$controls.find('.ipsH').off();this.$controls.find('.ipsOptions').off();$('body').off('click.ipWidgetTitle');}
