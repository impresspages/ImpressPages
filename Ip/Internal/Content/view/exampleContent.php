 ...
 */
?>
<?php ipRenderWidget('IpTitle', array('title' => 'This is an example title')); ?>

<?php ipRenderWidget('IpText', array('text' => '
...
')); ?>
<?php ipRenderWidget('IpTitle', array('title' => 'For titles always use "Title" widget'), 'level2'); ?>

<?php ipRenderWidget('IpTextImage', array('imageSmall' => 'Ip/Internal/Content/img/example_image.jpg', 'text' => '
...
<?php ipRenderWidget('IpTitle', array('title' => 'Have a great experience to get most out of your website!'), 'level3'); ?>
