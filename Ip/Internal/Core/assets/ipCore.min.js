...
function ipHomeUrl()
{return ip.homeUrl;}
function ipInitForms(){ipModuleFormAdmin.init();ipModuleFormPublic.init();}
(function(jQuery){
/*!
 ...
 */
var ipGoogleMapsLoading=false;$(document).ready(function(){$('.ipWidget-Form').ipWidgetForm();if($('.ipWidget-Map').length){$('body').on('ipGoogleMapsLoaded',function(){$('.ipWidget-Map').ipWidgetMap();});if(typeof(google)!=='undefined'&&typeof(google.maps)!=='undefined'&&typeof(google.maps.LatLng)!=='undefined'){ipGoogleMapsLoaded();}else{ipLoadGoogleMaps();}}
ipInitForms();});var ipGoogleMapsLoaded=function(){$('body').trigger('ipGoogleMapsLoaded');};var ipLoadGoogleMaps=function(){if(ipGoogleMapsLoading){return;}
