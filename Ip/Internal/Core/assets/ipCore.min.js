...
$('.ipsModuleForm').each(function(){var $form=$(this);console.log($form.find(":submit").length);if($form.find(":submit").length==0){$form.append('<input type="submit" style="position: absolute; left: -999999px; width: 1px; height: 1px; visibility: hidden;" tabindex="-1" />');}});};};})(jQuery);var validatorConfig='';var ipValidator;(function($){"use strict";ipValidator=new function(){this.init=function(){$.each(ipValidatorTranslations,function(key,value){if(validatorConfig===''){validatorConfig=createConfig(key);}
...
var $widget=$(this);var $map=$widget.find('.ipsMap');var data=$map.data();if(!$widget.data('initialized')||true){if(typeof(data.lat)=='undefined'){data.lat=0;}
...
var map=new google.maps.Map($map.get(0),mapOptions);if((typeof($map.data('markerlat')!=='undefined'))&&(typeof($map.data('markerlng')!=='undefined'))){var marker=new google.maps.Marker({position:new google.maps.LatLng($map.data('markerlat'),$map.data('markerlng')),map:map});}}});};var ipGoogleMapsLoading=false;$(document).ready(function(){$('.ipWidget-Form').ipWidgetForm();if($('.ipWidget-Form').length){$('body').on('ipGoogleMapsLoaded',function(){$('.ipWidget-Map').ipWidgetMap();});if(typeof(google)!=='undefined'&&typeof(google.maps)!=='undefined'&&typeof(google.maps.LatLng)!=='undefined'){ipGoogleMapsLoaded();}else{ipLoadGoogleMaps();}}});var ipGoogleMapsLoaded=function(){$('body').trigger('ipGoogleMapsLoaded');}
