...
$this.data('ipFormRepositoryFile',{inputName:$this.data('inputname'),limit:parseInt($this.data('filelimit')),preview:parseInt($this.data('preview'))});$this.find('.ipsFiles .ipsFile .ipsRemove').on('click',$.proxy(removeFile,this));}});},_getFiles:function(){var $this=$(this);var files=new Array();$this.find('.ipsFiles div').each(function(){var $this=$(this);if($this.data('deleted')){return;}
