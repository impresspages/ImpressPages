...
$this.find('.ipsFiles').append($newFile);}};var removeFile=function(e){var $this=$(this);var $currentTarget=$(e.currentTarget);var $file=$currentTarget.closest('.ipsFile');$this.find('.ipsFileTemplate input').change();$file.remove();};$.fn.ipFormRepositoryFile=function(method){if(methods[method]){return methods[method].apply(this,Array.prototype.slice.call(arguments,1));}else if(typeof method==='object'||!method){return methods.init.apply(this,arguments);}else{$.error('Method '+method+' does not exist on jQuery.ipFormRepositoryFile');}};})(jQuery);(function($){"use strict";var methods={init:function(options){if(typeof(options)==='undefined'){options={};}
