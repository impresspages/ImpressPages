 ...
 */
var ipGoogleMapsLoading=false;var ipGoogleMapsLoaded=false;var ipPingInterval;$(document).ready(function(){if($('.ipWidget-Map').length){$('body').on('ipGoogleMapsLoaded',function(){$('.ipWidget-Map').ipWidgetMap();});if(typeof(google)!=='undefined'&&typeof(google.maps)!=='undefined'&&typeof(google.maps.LatLng)!=='undefined'){ipGoogleMapsLoaded();}else{ipLoadGoogleMaps();}}
ipInitForms();ipPingInterval=setInterval(ipPing,1000*60*4);$(document).on('ipContentManagementInit',function(){$(document.body).addClass('ipHasAdminPanel');});$(document).on('ipAdminPanelInit',function(){$(document.body).addClass('ipHasAdminNavbar');});});var ipGoogleMapsLoaded=function(){ipGoogleMapsLoading=false;ipGoogleMapsLoaded=true;$(document.body).trigger('ipGoogleMapsLoaded');};var ipLoadGoogleMaps=function(){if(ipGoogleMapsLoaded){ipGoogleMapsLoaded();}
