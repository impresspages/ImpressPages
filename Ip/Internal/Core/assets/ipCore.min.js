...
if($.fn.ipFormFile){$('.ipsModuleFormPublic .ipsFileContainer').ipFormFile();}else{}
if($.fn.ipFormRepositoryFile){$('.ipsModuleFormPublic .ipsRepositoryFileContainer').ipFormRepositoryFile();}else{}
if($.fn.ipFormRichtext){$('.ipsModuleFormAdmin .type-richtext').ipFormRichtext();}else{}
$('.ipsModuleFormPublic').each(function(){var $form=$(this);if($form.find(":submit").length==0){$form.append('<input type="submit" style="position: absolute; left: -999999px; width: 1px; height: 1px; visibility: hidden;" tabindex="-1" />');}});};};})(jQuery);var validatorConfig='';var ipValidator;(function($){"use strict";ipValidator=new function(){this.init=function(){$.each(ipValidatorTranslations,function(key,value){if(validatorConfig===''){validatorConfig=createConfig(key);}
