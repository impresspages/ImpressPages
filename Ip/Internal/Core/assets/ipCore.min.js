...
if($.ipFormRepositoryFile){$('.ipsModuleForm .ipsRepositoryFileContainer').ipFormRepositoryFile();}else{}};};})(jQuery);var validatorConfig='';var ipValidator;(function($){"use strict";ipValidator=new function(){this.init=function(){$.each(ipValidatorTranslations,function(key,value){if(validatorConfig===''){validatorConfig=createConfig(key);}
...
var map=new google.maps.Map($map.get(0),mapOptions);if((typeof($widget.data('markerlat')!=='undefined'))&&(typeof($widget.data('markerlng')!=='undefined'))){var marker=new google.maps.Marker({position:new google.maps.LatLng($(this).data('markerlat'),$widget.data('markerlng')),map:map});}}});};var ipGoogleMapsLoading=false;$(document).ready(function(){$('.ipWidget-Form').ipWidgetForm();if($('.ipWidget-Form').length){$('body').on('ipGoogleMapsLoaded',function(){$('.ipWidget-Map').ipWidgetMap();});if(typeof(google)!=='undefined'&&typeof(google.maps)!=='undefined'&&typeof(google.maps.LatLng)!=='undefined'){ipGoogleMapsLoaded();}else{ipLoadGoogleMaps();}}});var ipGoogleMapsLoaded=function(){$('body').trigger('ipGoogleMapsLoaded');}
