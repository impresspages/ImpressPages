...
$('.ipsModuleFormPublic .ipsFileContainer').ipFormFile();$('.ipsModuleFormPublic .type-richtext').ipFormRichtext();$('.ipsModuleFormPublic .type-url').ipFormUrl();$('.ipsModuleFormPublic').each(function(){var $form=$(this);if($form.find(":submit").length==0){$form.append('<input type="submit" style="position: absolute; left: -999999px; width: 1px; height: 1px; visibility: hidden;" tabindex="-1" />');}});};};})(jQuery);var validatorConfig='';var ipValidator;(function($){"use strict";ipValidator=new function(){this.init=function(){$.each(ipValidatorTranslations,function(key,value){if(validatorConfig===''){validatorConfig=createConfig(key);}
