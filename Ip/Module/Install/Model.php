...
//sessions are checked using curl. If there is no curl, session availability hasn't been checked
        ...
        $table[] = '<b>/Themes/</b> ' . __('writable', 'ipInstall');
    ...
    {
        $all_sql = file_get_contents(ipConfig()->coreModuleFile('Install/sql/structure.sql'));
    ...
    public static function importData($tablePrefix)
    {
        ...
        $sqlFile = ipConfig()->coreModuleFile("Install/sql/data.sql");
        $fh = fopen($sqlFile, 'r');
