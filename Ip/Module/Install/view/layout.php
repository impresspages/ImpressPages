...
<div class="container">
    ...
    <div class="clear"></div>
    <div id="wrapper">
        <p id="installationNotice"><?php echo __('ImpressPages CMS installation wizard', 'ipInstall') ?> <span><?php printf(__('Version %s', 'ipInstall'), \Ip\Application::getVersion()) ?></span></p>
        <div class="clear"></div>
