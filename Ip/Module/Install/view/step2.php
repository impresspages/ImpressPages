...
<p>This program is free software: you can redistribute it and/or modify it under the terms of the <a href="<?php echo ipGetConfig()->baseUrl('ip_license.html') ?>">GNU General Public License or MIT License</a>.</p>
...
<p>
    <a class="button_act" href="?step=3"><?php _e('Accept', 'ipInstall') ?></a>
    <a class="button" href="?step=1"><?php _e('Back', 'ipInstall') ?></a>
</p>