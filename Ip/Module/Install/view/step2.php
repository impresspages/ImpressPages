<h1><?php IP_STEP_LICENSE_LONG ?></h1>
<p>
...
<p>This program is free software: you can redistribute it and/or modify it under the terms of the <a href="<?php echo \Ip\Config::baseUrl('ip_license.html') ?>">GNU General Public License or MIT License</a>.</p>
...
<p>
    <a class="button_act" href="?step=3"><?php echo IP_ACCEPT ?></a>
    <a class="button" href="?step=1"><?php echo IP_BACK ?></a>
</p>