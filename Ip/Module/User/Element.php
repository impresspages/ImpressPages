...
class Element extends \Ip\Frontend\Element {
    ...
    public function __construct($id, $zoneName){
        ...
        switch($id){
            case 'password_reset':
                $this->buttonTitle = $parametersMod->getValue('User.title_password_reset');
                $this->pageTitle = $parametersMod->getValue('User.title_password_reset');
                break;
            ...
            case 'registration_verification_required':
                $this->buttonTitle = $parametersMod->getValue('User.title_registration');
                $this->pageTitle = $parametersMod->getValue('User.title_registration');
                break;
            ...
            case 'new_email_verified':
                $this->buttonTitle = $parametersMod->getValue('User.title_profile');
                $this->pageTitle = $parametersMod->getValue('User.title_profile');
                break;
            ...
            case 'new_email_verification_error':
                $this->buttonTitle = $parametersMod->getValue('User.title_new_email_verification_error');
                $this->pageTitle = $parametersMod->getValue('User.title_new_email_verification_error');
                break;


            case 'login':
                $this->buttonTitle = $parametersMod->getValue('User.title_login');
                $this->pageTitle = $parametersMod->getValue('User.title_login');
                break;
            case 'profile':
                $this->buttonTitle = $parametersMod->getValue('User.title_profile');
                $this->pageTitle = $parametersMod->getValue('User.title_profile');
    ...
    public function generateContent() {
        ...
        switch($this->getId()) {
            ...
            case 'registration':
                ...
                break;
            case 'registration_verification_required':
                $title = $parametersMod->getValue('User.title_registration');
                $text = $parametersMod->getValue('User.text_registration_verification_required');
            ...
            case 'logout':
                ...
                break;
            case 'verification_error_user_exist':
                $title = $parametersMod->getValue('User.title_registration_verification_error');
                $text = $parametersMod->getValue('User.text_user_exist_error');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
                break;
            case 'registration_verified':
            ...
            case 'profile':
                ...
                break;
            case 'new_email_verification_required':
                $title = $parametersMod->getValue('User.title_profile');
                $text = $parametersMod->getValue('User.text_new_email_verification_required');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
                break;
            case 'password_reset':
                if ($session->loggedIn()) {
                    ...
                    } elseif($parametersMod->getValue('User.zone_after_login')) {
                        $answer .= '<script type="text/javascript">document.location = \''.$site->generateUrl(null, $parametersMod->getValue('User.zone_after_login')).'\';</script>';
                    } else {
                ...
                break;
            case 'password_reset_sent_text':
                $title = $parametersMod->getValue('User.title_password_reset');
                $text = $parametersMod->getValue('User.text_password_reset_sent');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
                break;
            case 'password_reset_verification_error':
                $title = $parametersMod->getValue('User.title_password_reset');
                $text = $parametersMod->getValue('User.text_password_verification_error');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
                break;
            case 'password_reset_verified':
            ...
            case 'registration_verification_error':
                $title = $parametersMod->getValue('User.title_registration_verification_error');
                $text = $parametersMod->getValue('User.text_registration_verification_error');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
                break;
            case 'verification_error_email_exist':
                $title = $parametersMod->getValue('User.title_registration_verification_error');
                $text = $parametersMod->getValue('User.text_email_exist_error');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
                break;
            case 'new_email_verification_error':
                $title = $parametersMod->getValue('User.title_new_email_verification_error');
                $text = $parametersMod->getValue('User.text_new_email_verification_error');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
            break;
            case 'renewed_registration':
                $title = $parametersMod->getValue('User.title_registration');
                $text = $parametersMod->getValue('User.text_account_renewed');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
                break;
            case 'renew_registration_error':
                $title = $parametersMod->getValue('User.title_registration');
                $text = $parametersMod->getValue('User.text_account_renewal_error');
                $answer .= \Ip\View::create('view/text.php', array('title' => $title, 'text' => $text))->render();
                break;
        }
