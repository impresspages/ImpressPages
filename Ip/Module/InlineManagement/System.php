...
class System
{
    function init()
    {
        ...
        if (\Ip\ServiceLocator::getContent()->isManagementState()) {
            ...
            ipAddCss(\Ip\Config::coreModuleUrl('Assets/assets/js/jquery-colorpicker/colorpicker.css'));
            ipAddJavascript(\Ip\Config::coreModuleUrl('Assets/assets/js/jquery-colorpicker/colorpicker.js'));
        }
    }
}
