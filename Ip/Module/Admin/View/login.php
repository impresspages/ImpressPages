...
<head>
    ...
    <link rel="stylesheet" href="<?php echo \Ip\Config::coreUrl('Ip/Backend/design/login/login.css') ?>">
...
<a href="http://www.impresspages.org/" class="logo" target="_blank"><img src="<?php echo \Ip\Config::coreUrl('Ip/Backend/design/login/logo.png') ?>"></a>
