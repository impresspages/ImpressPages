<div class="ipaQuestion">
    <label class="ipAdminLabel"><?php echo $this->escPar('Content.widget_faq.question') ?></label>
    <input name="question" class="ipAdminInput" value="<?php echo htmlspecialchars(isset($question) ? $question : '' ); ?>" />
</div>
<div class="ipaAnswer">
    <label class="ipAdminLabel"><?php echo $this->escPar('Content.widget_faq.answer') ?></label>
