<label class="ipAdminLabel"><?php echo $this->escPar('Content.widget_title.title') ?><br/>
...
<div class="ipsTitleOptions" style="display: none;">
    <label class="ipAdminLabel"><?php echo $this->escPar('Content.widget_title.anchor'); ?> <span class="ipsAnchorPreview ipmAnchorPreview"><?php echo $curUrl ?>#<?php echo htmlspecialchars(isset($id) ? $id : '' ); ?></span><br/>
