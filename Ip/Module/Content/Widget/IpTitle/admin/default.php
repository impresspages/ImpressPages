<label class="ipAdminLabel"><?php __('Title', 'ipAdmin') ?><br/>
...
<div class="ipsTitleOptions" style="display: none;">
    <label class="ipAdminLabel"><?php __('Anchor', 'ipAdmin'); ?> <span class="ipsAnchorPreview ipmAnchorPreview"><?php echo $curUrl ?>#<?php echo htmlspecialchars(isset($id) ? $id : '' ); ?></span><br/>
