...
class System{
    ...
    public static function collectFieldTypes($fieldTypes, $info = NULL)
    {
        ...
        $fieldTypes['IpConfirm']= new FieldType('IpConfirm', '\Ip\Form\Field\Confirm', $typeConfirm, 'ipWidgetIpForm_InitWysiwygOptions', 'ipWidgetIpForm_SaveWysiwygOptions', \Ip\View::create('view/form_field_options/wysiwyg.php')->render());
