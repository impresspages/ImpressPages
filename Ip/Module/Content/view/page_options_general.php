<form id="formGeneral">
    <p class="field">
        ...
        <input id="generalButtonTitle" name="buttonTitle" value="<?php echo ipEsc($element->getButtonTitle()) ?>" />
        <br />
    </p>
    <p class="field">
    ...
    <p class="field">
        ...
        <span class="error" id="createdOnError"></span> <input id="generalCreatedOn" name="createdOn"
            value="<?php echo ipEsc(substr($element->getCreatedOn(), 0, 10)) ?>" /><br />
    </p>
    <p class="field">
        ...
        <input id="generalLastModified" name="lastModified" value="<?php echo ipEsc(substr($element->getLastModified(), 0, 10)) ?>" /><br />
    </p>
</form>
