...
<head>
    ...
    <link href="' . ipFileUrl('Ip/Module/Assets/assets/css/bootstrap/bootstrap.css') . '" type="text/css" rel="stylesheet" media="screen" />
    ...
    <script type="text/javascript" src="' . ipFileUrl('Ip/Module/Assets/assets/css/bootstrap/bootstrap.js') . '"></script>
