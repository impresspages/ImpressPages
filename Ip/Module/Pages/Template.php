...
<head>
    '.ipPrintHead(false).'
    <link href="' . ipUrl('Ip/Module/Assets/assets/fonts/font-awesome/font-awesome.css') . '" type="text/css" rel="stylesheet" media="screen" />
    <link href="' . ipUrl('Ip/Module/Assets/assets/css/bootstrap/bootstrap.css') . '" type="text/css" rel="stylesheet" media="screen" />
    <link href="' . ipUrl('Ip/Module/Pages/assets/pages.css') . '" type="text/css" rel="stylesheet" media="screen" />
    <link href="' . ipUrl('Ip/Module/Pages/jquery-ui/jquery-ui.css') . '" type="text/css" rel="stylesheet" media="screen" />
    '.ipPrintJavascript(false).'
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Assets/assets/js/default.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Assets/assets/css/bootstrap/bootstrap.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Pages/jstree/jquery.cookie.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Pages/jstree/jquery.hotkeys.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Pages/jstree/jquery.jstree.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Pages/assets/pages.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Pages/assets/zoneProperties.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Pages/assets/languageProperties.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Pages/assets/layout.js') . '"></script>
    <script type="text/javascript" src="' . ipUrl('Ip/Module/Pages/jquery-ui/jquery-ui.js') . '"></script>
</head>
<body>
'.$content.'
</body>
...
<form id="formAdvanced">
        ...
        <p class="field">
            ...
            <img class="linkList" id="internalLinkingIcon" src="' . ipUrl('Ip/Module/Pages/img/list.gif') . '" /><br />
        </p>
