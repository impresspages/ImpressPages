...
class ZoneModel{
    ...
    public static function updateZone($languageId, $zoneId, $data) {
        ...
        if ($originalUrl != $newUrl){
            ...
            \Ip\ServiceLocator::getDispatcher()->notify(new \Ip\Event\UrlChanged(null, $fullOldUrl, $fullNewUrl));
        }
    }


    private static function makeUrl($languageUrl, $zoneUrl){
        $answer = ipGetConfig()->baseUrl(urlencode($languageUrl).'/'.urlencode($zoneUrl).'/');
        return $answer;
    }
