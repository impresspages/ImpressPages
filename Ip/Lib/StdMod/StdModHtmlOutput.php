...
class StdModHtmlOutput{
    ...
    function dateTime($name, $value = '', $disabled = false){
        ...
        $this->html .= '<script src="' . ipConfig()->oldModuleUrl('developer/std_mod/calendar/datetimepicker_css.js') . '"></script>' ;
        $this->html .= '<script src="' . ipConfig()->oldModuleUrl('developer/std_mod/calendar/datetimepicker_css.js') . '"></script>' ;
    ...
    <a href="javascript: NewCssCal(\''.htmlspecialchars($name).'\',\'yyyymmdd\',\'dropdown\',true,24,false)"><img src="' . ipConfig()->oldModuleUrl('developer/std_mod/calendar/images/cal.gif') . '"" border="0"/></a>' ;
    }
    ...
    function date($name, $value = '', $disabled = false){
        ...
        $this->html .= '<script src="' . ipConfig()->oldModuleUrl('developer/std_mod/calendar/datetimepicker_css.js') . '"></script>' ;
        $this->html .= '<input id="'.htmlspecialchars($name).'" autocomplete="off" '.$disabledStr.' class="stdMod" name="'.htmlspecialchars($name).'" value="'.htmlspecialchars($value).'"/>
    <a href="javascript: NewCssCal(\''.htmlspecialchars($name).'\',\'yyyymmdd\',\'dropdown\',false,24,false)"><img src="' . ipConfig()->oldModuleUrl('developer/std_mod/calendar/images/cal.gif') . '"" border="0"/></a>' ;
    }
