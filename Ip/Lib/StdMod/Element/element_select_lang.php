...
class ElementSelectLang extends Element{ //data element in area
    ...
    function printFieldUpdate($prefix, $record, $area){
        ...
        $answer = '';
        $sql2 = "select * from `".DB_PREF.ip_deprecated_mysql_real_escape_string($this->translationTable)."` t where t.`".$this->recordIdField."` = '".$record[$area->dbPrimaryKey]."' ";
    ...
    where `".ip_deprecated_mysql_real_escape_string($this->translationField)."` = '".ip_deprecated_mysql_real_escape_string($value)."'";
