...
class Script {
    ...
    public function updateDatabase() {
        ...
        $answer = '';
        if (\Db_100::getSystemVariable('version') != '2.4') {
            ...
            if ($group) {
                if(!\Db_100::getParameter('standard', 'content_management', 'admin_translations', 'save_now_hint')) {
                    \Db_100::addStringParameter($group['id'], 'Save now hint', 'save_now_hint', 'Save now - publish later', 1);
                }
                if(!\Db_100::getParameter('standard', 'content_management', 'admin_translations', 'search_widgets')) {
                    \Db_100::addStringParameter($group['id'], 'Search widgets', 'search_widgets', 'Search widgets', 1);
                }
            }
            
            
            if ($this->curStep == $this->stepCount){
                \Db_100::setSystemVariable('version','2.4');
            }
        }
