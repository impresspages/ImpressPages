...
<p>The confirmation e-mail has been sent to your e-mail address. Please confirm the registration by clicking on the link in the email.</p>";
    ...
    $parameterTitle["community"]["user"]["translations"]["text_new_email_verification_required"] = "Text - new email verification required";
    $parameterValue["community"]["user"]["translations"]["text_new_email_verification_required"] = "<p>To update the e-mail a confirmation link has been sent to your new e-mail address. Please confirm new data by clicking on the link in the e-mail.</p>";
    ...
    $parameterTitle["community"]["user"]["translations"]["text_email_exist_error"] = "Text - email exist error";
    ...
    $parameterValue["community"]["user"]["translations"]["text_password_verification_error"] = "Verification of new password has failed."; /* changed */
