...
define ('TEST_TMP_URL', $isTravis ? 'http://localhost/phpunit/tmp/' : 'http://localhost/ipcomposer/phpunit/tmp/');
...
define ('TEST_SCREENSHOT_URL', $isTravis ? 'http://localhost/phpunit/screenshots/' : 'http://localhost/ipcomposer/phpunit/screenshots/');

define('CURRENT_VERSION', '4.6.4'); //CHANGE_ON_VERSION_UPDATE
define('CURRENT_DBVERSION', 85); //CHANGE_ON_VERSION_UPDATE
