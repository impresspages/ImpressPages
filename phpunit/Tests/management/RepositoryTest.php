...
class RepositoryTestTest extends \PhpUnit\SeleniumTestCase
{
    public function testNewFilesUploadRemoval()
    {
        ...
        //try to upload file
        $this->assertEquals(file_exists($installation->getConfig('BASE_DIR').'file/repository/testFile.txt'), FALSE);
        ...
        $this->assertEquals(file_exists($installation->getConfig('BASE_DIR') . 'file/repository/testFile.txt'), TRUE);
