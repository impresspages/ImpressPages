...
class ServiceTest extends \PhpUnit\GeneralTestCase
{
    ...
    public function testProcess()
    {
        ...
        $this->assertEquals('', file_get_contents($installation->getInstallationDir().'license.html'));
        ...
        $this->assertEquals(true, strlen(file_get_contents($installation->getInstallationDir().'license.html')) > 10);
