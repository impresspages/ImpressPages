...
class IpImageMigrationTest extends \PhpUnit\MigrationTestCase
{
    ...
    {
        return $this->createXMLDataSet(TEST_FIXTURE_DIR.'update/Library/Migration/To3_0/ipImage.xml');
    }
    ...
    public function testIpImageMigration()
    {
        ...
        $expectedTable = $this->createXMLDataSet(TEST_FIXTURE_DIR.'update/Library/Migration/To3_0/ipImageResult.xml')->getTable("ip_m_content_management_widget");
