...
class IpLogoGalleryMigrationTest extends \PhpUnit\MigrationTestCase
{
    ...
    {
        return $this->createXMLDataSet(TEST_FIXTURE_DIR.'update/Library/Migration/To2_7/ipLogoGallery.xml');
    }
    ...
    public function testIpImageMigration()
    {
        ...
        $expectedTable = $this->createXMLDataSet(TEST_FIXTURE_DIR.'update/Library/Migration/To2_7/ipLogoGalleryResult.xml')->getTable("ip_m_content_management_widget");
