...
/*      if (PHP_VERSION < 6) { //2009-08-18 Mangirdas Skripka (warning in PHP 5.3)
        $magic_quotes = get_magic_quotes_runtime();
        set_magic_quotes_runtime(0);
      }*/
      $file_buffer  = file_get_contents($path);
      $file_buffer  = $this->EncodeString($file_buffer, $encoding);
//      if (PHP_VERSION < 6) { set_magic_quotes_runtime($magic_quotes); }  //2009-08-18 Mangirdas Skripka (warning in PHP 5.3)
      return $file_buffer;
    } catch (Exception $e) {
      $this->SetError($e->getMessage());
      return '';
