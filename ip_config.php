 ...
 */
    ...
    // GLOBAL
      define('SESSION_NAME', 'ses1128829803');  //prevents session conflict when two sites runs on the same server
    // END GLOBAL
    ...
    // DB
      ...
      define('DB_PASSWORD', '');
      define('DB_DATABASE', 'ip2.x');
      define('DB_PREF', 'ip_');
    // END DB
    
    // GLOBAL
      define('BASE_DIR', '/opt/lampp/htdocs/ip2.x/'); //root DIR with trainling slash at the end. If you have moved your site to another place, change this line to correspond your new domain.
      define('BASE_URL', 'http://localhost/ip2.x/'); //root url with trainling slash at the end. If you have moved your site to another place, change this line to correspond your new domain.
      ...
      define('ERRORS_SEND', 'test@impresspages.org'); //insert email address or leave blank. If email is set, you will get an email when an error occurs.
    // END GLOBAL
