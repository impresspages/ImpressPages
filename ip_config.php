 ...
 */
	...
	// GLOBAL
	  define('SESSION_NAME', 'ses30402');  //prevents session conflict when two sites runs on the same server
	// END GLOBAL
	...
	// DB
	  ...
	  define('DB_PASSWORD', '');
	  define('DB_DATABASE', 'ip_git');
	  define('DB_PREF', 'ip_cm2_');
	// END DB

	// GLOBAL
	  define('BASE_DIR', 'E:/xampp/htdocs/ip/'); //root DIR with trainling slash at the end. If you have moved your site to another place, change this line to correspond your new domain.
	  define('BASE_URL', 'http://localhost/ip/'); //root url with trainling slash at the end. If you have moved your site to another place, change this line to correspond your new domain.
	  ...
	  define('ERRORS_SEND', 'mangirdas@apro.lt'); //insert email address or leave blank. If email is set, you will get an email when an error occurs.
	// END GLOBAL
