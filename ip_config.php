 ...
 */
	...
	// GLOBAL
	  define('SESSION_NAME', 'ses17045');  //prevents session conflict when two sites runs on the same server
	// END GLOBAL
	...
	// GLOBAL
	  define('BASE_DIR', 'D:/xampp/htdocs/ip/'); //root DIR with trainling slash at the end. If you have moved your site to another place, change this line to correspond your new domain.
