...
class Db {
    ...
    public static function updateModuleGroupTranslation($moduleGroupId, $newTranslation) {
        $sql = "update `".DB_PREF."module_group` set `translation` = '".ip_deprecated_mysql_real_escape_string($newTranslation)."' where `id` = ".(int)$moduleGroupId." ";
        $rs = ip_deprecated_mysql_query($sql);
        if(!$rs) {
            trigger_error($sql." ".ip_deprecated_mysql_error());
            return false;
    ...
    public static function updateModuleTranslation($moduleId, $newTranslation) {
        $sql = "update `".DB_PREF."module` set `translation` = '".ip_deprecated_mysql_real_escape_string($newTranslation)."' where `id` = ".(int)$moduleId." ";
        $rs = ip_deprecated_mysql_query($sql);
        if(!$rs) {
            trigger_error($sql." ".ip_deprecated_mysql_error());
            return false;
    ...
    d_short = '".ip_deprecated_mysql_real_escape_string($languageData['d_short'])."',
    d_long = '".ip_deprecated_mysql_real_escape_string($languageData['d_long'])."',
    visible = 0,
    row_number = ".$max_row_number.",
    url = '".ip_deprecated_mysql_real_escape_string($languageData['url'])."',
    code = '".ip_deprecated_mysql_real_escape_string($languageData['code'])."'
    ...
    public static function getLanguageId($languageCode) {
        $sql = "select id from `".DB_PREF."language` where `code` = '".ip_deprecated_mysql_real_escape_string($languageCode)."' ";
        $rs = ip_deprecated_mysql_query($sql);
        if(!$rs) {
            trigger_error($sql." ".ip_deprecated_mysql_error());
            return false;
    ...
    public static function renameParameter($id, $translation) {
        $sql = "update `".DB_PREF."parameter` set `translation` = '".ip_deprecated_mysql_real_escape_string($translation)."' where `id` = ".(int)$id." ";
        $rs = ip_deprecated_mysql_query($sql);
        if(!$rs) {
            trigger_error($sql." ".ip_deprecated_mysql_error());
            return false;
    ...
    public static function renameParameterGroup($id, $translation) {
        $sql = "update `".DB_PREF."parameter_group` set `translation` = '".ip_deprecated_mysql_real_escape_string($translation)."' where `id` = ".(int)$id." ";
        $rs = ip_deprecated_mysql_query($sql);
        if(!$rs) {
            trigger_error($sql." ".ip_deprecated_mysql_error());
            return false;
    ...
    public static function insertParameter($groupId, $parameter) {
      ...
      `comment` = '".ip_deprecated_mysql_real_escape_string($parameter['comment'])."',
