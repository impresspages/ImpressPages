...
class Config // extends MimeType
{
    ...
    tinyMCE.init( {
      ...
      valid_elements : "@[colspan|rowspan|class|style],strong,em,br,sup,sub,p,span,b,u,i,a[name|href|target|title],ul,ol,li,div,h1,table[border|width|cellspaceing|cellpadding|align],tbody,thead,th,tr,td[bgcolor],img[src]",
