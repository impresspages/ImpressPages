...
//     $init_names .= ' document.getElementById(\'menuModButtonNew'.$i.'\').new_paragraph_name = \''.$module['module_name'].'\';';
  ...
  function tep_preview_save_cancel_buttons() {
    ...
    $answer = "";
    $answer .= '
    <span class="ipCmsButtonBg"><a class="ipCmsButton ipCmsButtonPreview" href="'.str_replace("&cms_action=manage", "",str_replace("?cms_action=manage", "", $site->getCurrentUrl())).'" target="_newTab">'.$parametersMod->getValue('standard', 'content_management','admin_translations','preview').'</a></span>
