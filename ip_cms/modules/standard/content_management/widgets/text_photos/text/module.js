...
function content_mod_text() {
  ...
  function preview(worker_form, return_script, collection_number) {
    ...
    + '" />' + '<input name="module_key" value="text" />'
  ...
  function manage() {
    ...
    + widget_text_widget_title
    + '</label>'
    + '<form id="mod_' + this.collection_number	+ '_layout" action="">'	+ mod_text_layout + '</form>'
  ...
  function manage_init() {
    // var tekst_area = document.getElementById("management_" +
    // this.collection_number + "_text");
    // alert(tekst_area);
    ...
    eval(configWidgetTextPhotosTextMceInit);
