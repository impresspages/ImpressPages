...
<tr>
<td style="width: 33%; vertical-align: top;"><?php echo $site->generateBlock('multicol'.$baseId.'1')->exampleContent(' '); ?></td>
<td style="width: 33%; vertical-align: top;"><?php echo $site->generateBlock('multicol'.$baseId.'2')->exampleContent(' '); ?></td>
<td style="width: 33%; vertical-align: top;"><?php echo $site->generateBlock('multicol'.$baseId.'3')->exampleContent(' '); ?></td>
</tr>
</table>