<div style="padding: 10px;">
    <div class="ipWidget_ipPictureGallery_uploadFile" style="float: left;"></div>
    <div class="clear"><!--  --></div>
</div>
...
<ul class="ipWidget_ipPictureGallery_hidden">
    <li class="ipWidget_ipPictureGallery_pictureTemplate">
        <form>
            ...
            <input class="ipWidget_ipPictureGallery_pictureTitle" type="text" name="title" value=""/>
            <div class="ipWidget_ipPictureGallery_picturePreview" style="width:200px;"></div>
