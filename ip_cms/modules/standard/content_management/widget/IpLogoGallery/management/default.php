...
<ul class="ipWidget_ipLogoGallery_hidden">
    <li class="ipWidget_ipLogoGallery_logoTemplate">
        <form>
            ...
            <input class="ipWidget_ipLogoGallery_logoTitle" type="text" name="title" value=""/>
            <div class="ipWidget_ipLogoGallery_logoPreview" style="width:200px;"></div>
...
<div class="ipWidget_ipLogoGallery_hidden">
    <form>
        <input name="logoWidth" type="hidden" value="<?php echo (int)$logoWidth ?>" />
        <input type="logoHeight" value="<?php echo (int)$logoHeight ?>" />
    </form>
</div>
