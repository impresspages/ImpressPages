<div id="ipWidget_<?php echo $widgetRecord['instanceId']; ?>"
    class="ipWidget ipWidgetManagement ipWidget_<?php echo $widgetRecord['name']; ?>">
    <div class="ipWidgetManagementHeader">
        <span class="ipWidgetManagementTitle"><?php echo htmlspecialchars($widgetTitle) ?>
        </span> <select class="ipWidgetLayoutSelect">
    ...
    <div class="ipWidgetManagementFooter">
        <span class="ipWidgetButton ipWidgetSave">Save</span> <span
            class="ipWidgetButton ipWidgetCancel">Cancel</span>
        <div class="clear">
            <!--  -->
        </div>
    </div>
