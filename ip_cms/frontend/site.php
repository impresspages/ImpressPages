...
class Site{
    ...
    public function generateHead() {
        ...
        if (!empty($_POST['ipDesign']['pCfg']) && (defined('IP_ALLOW_PUBLIC_THEME_CONFIG') || isset($_REQUEST['ipDesignPreview']))) {
        ...
        if (!$inDesignPreview) {
            ...
            foreach($cssFiles as &$file) {
                ...
                if ($path['dirname'] == BASE_URL . THEME_DIR . THEME && file_exists(BASE_DIR . THEME_DIR . THEME . "/{$path['filename']}.less")) {
                    ...
                    $file = BASE_URL . THEME_DIR . THEME . '/ipAutogeneratedCss.css?';
                    $pCfg = !empty($_POST['ipDesign']['pCfg']) ? $_POST['ipDesign']['pCfg'] : array();
