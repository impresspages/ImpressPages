...
<html xmlns="http://www.w3.org/1999/xhtml"
    xml:lang="<?php echo $site->getCurrentLanguage()->getCode(); ?>"
    lang="<?php echo $site->currentLanguage['code']; ?>">
<head>
<?php echo $site->generateHead(); ?>
<link href="<?php echo BASE_URL.THEME_DIR.THEME ?>/ip_content.css"
    rel="stylesheet" type="text/css" />
<link href="<?php echo BASE_URL.THEME_DIR.THEME ?>/site.css"
    rel="stylesheet" type="text/css" />
</head>
<body>
    <div class="main">
