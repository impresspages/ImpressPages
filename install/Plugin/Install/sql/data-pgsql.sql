...
ALTER SEQUENCE "ip_page_id_seq" RESTART WITH 10;

INSERT INTO ip_revision ("revisionId", "pageId", "isPublished", "createdAt") VALUES
(1, 4, 1, '[[[[timestamp]]]]'),
(2, 5, 1, '[[[[timestamp]]]]');

ALTER SEQUENCE "ip_revision_id_seq" RESTART WITH 3;
...
ALTER SEQUENCE "ip_widget_id_seq" RESTART WITH 5;
...
('Ip', 'version', '"4.5.0"'),  /* //CHANGE_ON_VERSION_UPDATE */
('Ip', 'dbVersion', '78'), /* //CHANGE_ON_VERSION_UPDATE */
('Ip', 'theme', '"Air"'),
('Ip', 'cachedBaseUrl', ''),
