...
<p>This program is free software: you can redistribute it and/or modify it under the terms of the <a href="<?php echo ipConfig()->baseUrl('ip_license.html') ?>">GNU General Public License or MIT License</a>.</p>
