<h1><?php _e('ImpressPages Legal Notices', 'plugin-Install') ?></h1>
<p>
...
<p class="text-right">
    <a class="btn btn-default" href="?step=1"><?php _e('Back', 'plugin-Install') ?></a>
    <a class="btn btn-primary" href="?step=3"><?php _e('Accept', 'plugin-Install') ?></a>
</p>
